...
#ifndef _APPLENFORCEATACHANNEL_H
#define _APPLENFORCEATACHANNEL_H

#include <IOKit/IOService.h>
class AppleNForceATARoot;

class AppleNForceATAChannel : public IOService
{
    OSDeclareDefaultStructors( AppleNForceATAChannel )

protected:
    AppleNForceATARoot * fProvider;
...
#endif /* !_APPLENFORCEATACHANNEL_H */
