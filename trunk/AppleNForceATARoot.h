...
#ifndef _APPLENFORCEATAROOT_H
#define _APPLENFORCEATAROOT_H

#include <IOKit/IOLocks.h>
#include <IOKit/pci/IOPCIDevice.h>

class AppleNForceATARoot : public IOService
{
    OSDeclareDefaultStructors( AppleNForceATARoot )
